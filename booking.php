      ...
      <div class="col-sm-12">
        <form action="confirm-booking.php" method="post">
          ...
          <div class="flight-result_box_web2">
              <h1 class="wrap_subhding_web2 pb-2">Passenger Information</h1>
                        ...
                        <div class="row align-items-center traveller-row">
                          ...
                          <?php if ($showAddTraveller): ?>
                            <div class="col-auto mb-2 d-none d-md-block">
                              <button type="button" class="remove-traveller_tr_web2" style="visibility:hidden;">
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const addBtn = document.querySelector(".add-traveller_btn_web2");
  ...
  addBtn.addEventListener("click", function () {
    ...
    newRow.innerHTML = `
      <div class="col-12 col-sm-12 col-md col-lg-2 mb-2">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <button type="button" class="remove-traveller_tr_web2 mt-0 d-block d-md-none"><i class="fa-solid fa-minus"></i></button>
        </div>
      </div>
      <div class="col-6 col-sm-2 col-md mb-2">
          <label class="traveller-form_lbl_web2">First Name<span class="red">*</span></label>
      ...
      <div class="col-6 col-sm-2 col-md-auto mb-2 d-none d-md-block">
        <button type="button" class="remove-traveller_tr_web2"><i class="fa-solid fa-minus"></i></button>
      </div>
    `;
    ...
    newRow.querySelectorAll(".remove-traveller_tr_web2").forEach(btn => {
