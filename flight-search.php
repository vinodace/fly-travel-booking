  ...
  <div class="container">
    <div class="row justify-content-center">
      ...
      <div class="col-md-3 d-none d-lg-block">
        <div class="flightsidebar_filter-box_web2 pb-2 sticky-sidebar">
          <div class="flightsidebar_padding_web2">
            ...
            <button id="clearFilters" class="wrap-comman-btn mt-2">Clear Filters</button>
            <hr>
      ...
      <div class="col-md-9">
        ...
        ?>
            <div class="flight-result_box_web2 <?= $count > $limit ? 'd-none extra-flight' : '' ?>" data-airline="<?= htmlspecialchars(strtolower($airlineCode)) ?>">
                <div class="row">
                    <div class="col-md-9">
                            ...
                            <div class="row align-items-center mb-3">
                                <div class="col-md-3">
                                    <div class="d-flex d-md-block align-items-center justify-content-between mb-2 mb-md-0">
                                        ...
                                        <a href="#" class="flight-price_web2 d-block d-md-none">
                    ...
                    <div class="col-md-3 d-lg-flex flex-column justify-content-center text-center">
                        <div class="d-flex d-mb-block flex-column justify-content-between justify-content-md-center text-md-center">
                            <div>
                                <a href="#" class="flight-price_web2 d-none d-md-block">
                                    <?= getCurrencySymbol($offer["price"]["currency"]) . " " . $offer["price"]["total"] ?>
                                </a>
                            </div>
                            ...
                            <a href="booking.php?offerId=<?= urlencode($offer['id']) ?>&adults=<?= $adults ?>&children=<?= $children ?>&infants=<?= $infants ?>&travel_class=<?= urlencode($travel_class) ?>" class="wrap-comman-btn fligth-search_btn_web2 mt-0">Select</a>
                        </div>
                        <a href="javascript:void(0)" class="wrap_prgh_web2 text-center d-block text-primary pt-1" data-bs-toggle="modal" data-bs-target="#<?= $modalId ?>">Itinerary</a>
                    </div>
                </div>
            </div>
                  ...
                  <div class="modal-body">
                    <?php foreach ($offer['itineraries'] as $iIndex => $itinerary): ?>
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        <h6 class="wrap_subhding_web2 main_color_web2 pb-2">Itinerary <?= $iIndex + 1 ?></h6>

                        <?php
                            $rawDuration = $itinerary['duration'] ?? '';
                            $durationFormatted = $rawDuration ? formatDuration($rawDuration) : 'N/A';
                        ?>
                        <p class="wrap_subhding_web2 mb-0 pb-2">Duration: <?= $durationFormatted ?></p>
                      </div>  
        ...
        <?php
            ...
            if ($count > $limit): ?>
                <div class="text-center mt-3">
                    <button id="showMoreBtn" class="wrap-comman-btn bg-warning border-warning text-dark">Show More Flights</button>
                </div>
            <?php endif;
        else: ?>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const flights = document.querySelectorAll(".flight-result_box_web2");
