<?php 
	$phone_number_web2 = "+1-844-698-5012";
	$email_address_web2 = "info@flytravelbooking.com";
	$domainurl_web2 ="flytravelbooking.com";
	$domain_name_web2 = "Fly Travel Booking";
	...
	<div class="container">
		<nav class="navbar navbar-expand-lg navbar-light nav_x-padding">
		    ...
		    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		      ...
		      <a href="tel:<?php echo $phone_number_web2; ?>" class="header-tfn">
