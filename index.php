              ...
              <div class="col-sm-12">
                <div class="flight-search_bg_web2">
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3 pe-md-0">
                      <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-3 px-md-0">
                      <div class="form-group">   
                    ...
                    <div class="col-sm-6 col-md-6 mb-3 ps-md-0">
                      <div class="form-group">
...
<section class="pt-5 py-md-5 mt-md-5">
  <div class="container">
    <div class="row align-items-center">
...
<section class="container pt-4 pb-md-5">
  <div class="row align-items-center">
          ...
          <div class="col-md-4">
            <div class="disc_card">
              <div class="d-flex justify-content-between mb-2">
                <h2 class="wrap_subhding_web2 pt-0 text-primary">${symbol}${price}</h2>
