  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-lg-8">
        <div class="booking-review_card_web2">
          <h3 class="wrap_subhding_web2 text-success pt-0 pb-2">✅ Your booking details have been received!</h3>
          <P class="wrap_prgh_web2">Please review the summary below before proceeding to payment.</P>
        </div>
        <h3 class="wrap_subhding_web2 pt-4 pb-3">Flight Details</h3>
                ...
                <div class="col">
                    <div class="row text-center">
                        <div class="col-4">
                            ...
                            <p class="flight-location_web2"><?= $depAirportFull ?> (<?= $depAirportCode ?>)</p>
                        </div>
                        <div class="col-4">
                        ...
                        <div class="col-4">
                            ...
                            <p class="flight-location_web2"><?= $arrAirportFull ?> (<?= $arrAirportCode ?>)</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Passenger Info -->
        <div class="confirm_box_web2">
            <h3 class="wrap_subhding_web2 pt-0 pb-3">Passenger Details</h3>
            ...
            <!--Start Mobile Design -->
            <?php for($i = 0; $i < count($firstNames); $i++): ?>
            <div class="passenger_mob_design_web2 d-block d-md-none">
                <div class="row">
                    <div class="col-auto">
                        <div class="passenger-mob_num_web2"><?= $i+1 ?></div>
                    </div>
                    <div class="col">
                        <div class="d-flex gap-3">
                            <p class="passenger_mob_name_web2"><?= htmlspecialchars($firstNames[$i]) ?> <?= htmlspecialchars($lastNames[$i]) ?></p>
                            <p class="passenger_mob_gender_web2">(<?= htmlspecialchars(strtoupper($genders[$i])) ?>)</p>
                        </div>    
                        <p class="passenger_mob_dob_web2">
        ...
        <!-- Billing Info -->
        <div class="confirm_box_web2">
            <h3 class="wrap_subhding_web2 pt-0 pb-3">Billing Information</h3>
            <p class="wrap_prgh_web2 pb-1"><span class="summary_label_web2">Address:</span> <?= htmlspecialchars($address1.' '.$address2) ?></p>
            <p class="wrap_prgh_web2 pb-1"><span class="summary_label_web2">City:</span> <?= htmlspecialchars($city) ?>, <?= htmlspecialchars($state) ?></p>
            <p class="wrap_prgh_web2 pb-1"><span class="summary_label_web2">Country:</span> <?= htmlspecialchars($country) ?></p>
            <p class="wrap_prgh_web2 pb-1"><span class="summary_label_web2">Zip Code:</span> <?= htmlspecialchars($zip) ?></p>
        </div>

        <!-- Contact Info -->
        <div class="confirm_box_web2">
            <h3 class="wrap_subhding_web2 pt-0 pb-3">Contact Information</h3>
            <p class="wrap_prgh_web2 pb-1"><span class="summary_label_web2">Phone:</span> <?= htmlspecialchars($contact_info_phone) ?></p>
            <p class="wrap_prgh_web2 pb-1"><span class="summary_label_web2">Email:</span> <?= htmlspecialchars($contact_inf_email) ?></p>
        </div>

      </div>
      <div class="col-md-12 col-lg-4">
        <div class="confirm_box_web2 position-sticky top-0">
            <h3 class="wrap_subhding_web2 pt-0">Fare Summary</h3>
            <hr>
            <ul class="fare_summary_list_web2">
                <li>
                    <span>Base Fare</span>
            ...
            <a href="payment.php?offerId=<?= urlencode($offerId) ?>" class="wrap-comman-btn bg-success border-success mt-4 mx-auto d-table">Proceed to Secure Payment</a>

            <p class="wrap_prgh_web2 mt-3 text-muted text-center"><small><strong>Payment Notice</strong>: Your seat is reserved for a limited time. Please complete the payment to confirm your booking.</small></p>
        </div>
      </div>
