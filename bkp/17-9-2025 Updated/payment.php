...
<div class="container py-5">
  <div class="row justify-content-center">
    <div class="col-md-7">
      ...
      <div class="payment_box_web2 mx-auto">
        ...
        <div class="payment_card_box_web2">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <p class="wrap_prgh_web2 py-0">Debit/Credit Card</p>
            <img src="images/card-logo.png" alt="" class="payment_card_logo_web2">
          </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="position-relative mb-3">
                  <label class="payment_lbl_web2">Card Holder Name</label>
                  <input type="text" name="card_holder" class="payment_field_web2 alphabet"  required>
                  <div class="errmsg"></div>
                </div>

                <div class="position-relative mb-3">
                  <label class="payment_lbl_web2">Card Number</label>
                  <input type="text" name="card_number" maxlength="19" class="payment_field_web2 number" inputmode="numeric" required>
                  <div class="errmsg"></div>
                </div>
              </div>
              <div class="col-md-9">
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <div class="position-relative">
                      <label class="payment_lbl_web2">Expiry Month</label>
                      <!-- <input type="text" name="expiry_month" maxlength="2" class="form-control" maxlength="2" required> -->
                      <select name="expiry_month" class="payment_field_web2 required">
                  ...
                  <div class="col-md-6 mb-3">
                    <div class="position-relative">
                      <label class="payment_lbl_web2">Expiry Year</label>
                      <select name="expiry_year" class="payment_field_web2" required>
              ...
              <div class="col-md-3">
                <div class="position-relative mb-3">
                  <label class="payment_lbl_web2">CVV/CVC</label>
                  <input type="password" name="cvv" maxlength="4" class="payment_field_web2 number" inputmode="numeric" required>
                </div>
                <div class="errmsg"></div>
              </div>
            </div>  
            <div class="text-end">
              <button type="submit" class="wrap-comman-btn bg-success border-success">Pay & Confirm Booking</button>
            </div>
          </form>
        </div>
