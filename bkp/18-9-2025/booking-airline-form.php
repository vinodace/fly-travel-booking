<div class="col-sm-12">
      <form action="#confirm-booking.php" method="post">
        <div class="flight-result_box_web2">
          <h1 class="wrap_subhding_web2 mt-0 pt-0 pb-2">Passenger Information</h1>
            ...
            <table class="table passenger_table_web2" id="traveller-table">
              <tbody>
                ...
                <tr>
                  ...
                  <td width="150">
                    <label class="traveller-form_lbl_web2">First Name</label>
                    <input type="text" name="first-name" class="traveller-form_field_web2">
                  </td>
                  <td width="150">
                    <label class="traveller-form_lbl_web2">Middle Name</label>
                  ...
                  <td>
                    <label class="traveller-form_lbl_web2">Gender</label>
                  ...
                  <td>
                    <label class="traveller-form_lbl_web2">Date of Birth</label>
                    <select name="gender" class="traveller-form_field_web2">
                      <?php 
                        for($i =1; $i <=10; $i++) {
                  ...
                  <td>
                    <label class="traveller-form_lbl_web2">Month</label>
                  ...
                  <td>
                    <label class="traveller-form_lbl_web2">Year</label>
                    <select name="month" class="traveller-form_field_web2">
                      <?php 
                        for($b=1980; $b <=2025; $b++) {
